...
class PokemonView extends View {
  ...
  _pokemonViewChangeToSearch() {
    document.querySelector('.btn--prev').disabled = true;
    document.querySelector('.btn--next').disabled = true;
    document.querySelector('.btn--ellipse').disabled = true;
  }
  ...
  _generateMarkup() {
    ...
    <button
      onclick="window.location='#${curPokemon - 1}';"
      data-goto="${curPokemon - 1}"
  ...
  <div class="card">
    ...
    <div
      class="card__side card__side${
        this._data.pokemon.catched_pokemon === true
      ...
      <div class="card__pokemon-details">
        ...
        <div class="card__pokemon-details__picture--back">
          <figure class="card__pokemon-details-pic-back">
            <img
              class="card__pokemon-details-pic-back--img"
              src="${this._data.pokemon.picture}"
              alt="pict"
            />
          </figure>
        ...
        <div class="card__pokemon-atributes">
          ...
          <li class="card__pokemon-atribute">
            <div class="card__pokemon-atribute card__pokemon-atribute--types">
              type: ${this._data.pokemon.type
                .map(type => {
                  return `
              <p
                class="card__pokemon-atribute card__pokemon-atribute--type"
